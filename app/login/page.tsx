  ...
  return (
    <main className="login-page" dir="rtl">
      <section className="login-card">
        ...
        {error === "credentials" && (
          <p className="login-error">البريد الإلكتروني أو كلمة المرور غير صحيحة.</p>
        )}
        {error === "config" && (
        ...
        <form action="/api/auth/login" method="post" className="login-form">
          ...
          <label>
            البريد الإلكتروني
            <input name="email" type="email" autoComplete="username" defaultValue="ahmfh8@gmail.com" required autoFocus />
          </label>
          <label>
            كلمة المرور
